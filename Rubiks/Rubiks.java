...
public class Rubiks {
    ...
    class edgedFace{
        ...
        int[] edge1 = new int[4];//index 0 is the face and 1-3 are the elements or side of the face [1,(face 1) 0,1,2]
        int[] edge2 = new int[4];//                                                                 [0,0,1,2] cube[edge1[0][edge1[1]]cube[edge1[0][edge1[2]]cube[edge1[0][edge1[3]]
        int[] edge3 = new int[4];//index 0 is the face and 1-3 are the elements or side of the face [1,(face 1) 0,1,2]
        int[] edge4 = new int[4];
